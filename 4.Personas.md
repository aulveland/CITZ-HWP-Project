...
### Charles Johnson
Charles is an expert in health and wellness in the workplace and is dedicated to helping others learn.

-General employee  
-Age 29  
-Charles.Johnson@bcgov  

#### Key Goals:
Ensure users are being exposed to appropriate and factual information.

#### Key Concerns
Users have access to useful guidance.  

#### Success Definition:
Able to maintain a safe platform for users to contribute and inquire.    

#### User Story:
As a moderator I want an easy fast paced system because I have other tasks and responsibilities.  

As a moderator I want a backup moderator for days I am not available.  

**Personality Traits:** Honest - Intelligent - Dedicated - Organized - Confident

#### Needs:
-Skills to be a moderator (knowledge of community and website)  
-Easy to use website

#### Jobs To Do:
-Approve / remove users in community  
